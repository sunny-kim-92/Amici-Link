let obj = {
  ...
  "Case 49": {
    Respondent: [
      "Law Professors",
      "Erwin Chemerinsky and Alan Brownstein ",
      "Baptist Joint Committee for Religious Liberty, et al. ",
      "Political Scientists ",
      "Jewish Social Policy Action Network",
      "Unitarian Universalist Association of Congregations, et al.",
      "American Jewish Committee, et al..",
      "Freedom from Religion Foundation",
      "Center for Inquiry, et al. ",
      "National Conference for Community and Justice ",
      "Paul Finkelman, et al. ",
      "American Civil Liberties Union, et al. "
    ],
    Petitioner: [
      "Brevard County, Florida",
      "Justice and Freedom Fund",
      "League of California Cities in support of neither party",
      "Dr. Daniel L. Akin, et al.",
      "Southern Baptist Convention Ethics & Religious Liberty Commission",
      "Southeastern Legal Foundation",
      "Liberty Counsel",
      "State of South Carolina",
      "United States Senators Marco Rubio, et al.",
      "American Civil Rights Union",
      "American Center for Law & Justice",
      "Nathan Lewin",
      "Chaplain Alliance for Religious Liberty",
      "Virginia Christian Alliance, et al.",
      "Rev. Dr. Robert E. Palmer",
      " Eighty-five Members of Congress  serving in the U.S. House of Representatives",
      "Center for Constitutional Jurisprudence",
      "Gerard V. Bradley, et al.",
      ...
      "Wallbuilders, Inc.",
      "Indiana, et al.",
      "Board of Commissioners for Carroll County, Maryland, et al."
    ]
  },
  "Case 28": {
    Respondent: [
  ...
  "Case 25": {
    ...
    Petitioner: [
      ...
      "Oklahoma Sheriffs’ Association, et al.",
  ...
  "Case 20": {
    Respondent: [],
    Petitioner: [
      "National Organization of Social Security Claimants’ Representatives in support of neither party"
    ]
  },
  "Case 30": {
    Respondent: [
  ...
  "Case 22": {
    ...
    Petitioner: [
      "National Association of Counties, National League of Cities, U.S. Conference of Mayors, International City/County Management Association,  International Municipal Lawyers Association, National Sheriffs’ Association",
  ...
  "Case 27": { Respondent: [], Petitioner: ["NARFE"] },
